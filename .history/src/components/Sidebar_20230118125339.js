...
function Sidebar() {
  ...
  const [contactModelIsOpen, setContactModelIsOpen] = useState(false);
  ...
  const toggleModalContact = () => {
    setContactModelIsOpen(!contactModelIsOpen);
  };
  ...
  return (
    <div className="">
      ...
      {/* //Contact Model */}
      <Modal
        isOpen={contactModelIsOpen}
        onRequestClose={toggleModalContact}
        className="about-contact-modal"
        overlayClassName="about-modal-overlay"
      >
        <button className="modal-close-btn-contact" onClick={toggleModalContact}>
          <GrClose />
        </button>
        <Contact />
      </Modal>
